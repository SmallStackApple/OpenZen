...
implements SettingRenderer {
    ...
    public int render(GuiGraphics guiGraphics, Setting<?> setting, int x, int y, int width, int mouseX, int mouseY, float alpha, float scale) {
        ...
        float toggleAnim = this.toggleAnimations.getOrDefault(booleanSetting, Float.valueOf(booleanSetting.getValue() != false ? 1.0f : 0.0f)).floatValue();
        ...
        this.toggleAnimations.put(booleanSetting, Float.valueOf(toggleAnim));
        ...
        float hoverAnim = this.hoverAnimations.getOrDefault(booleanSetting, Float.valueOf(0.0f)).floatValue();
        ...
        this.hoverAnimations.put(booleanSetting, Float.valueOf(hoverAnim));
